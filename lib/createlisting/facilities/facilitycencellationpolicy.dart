...
import 'package:sporforya/createlisting/events/eventnicejob.dart';
import 'package:sporforya/createlisting/events/eventscheduleandprice.dart';
import 'package:sporforya/createlisting/facilities/facilitycreatepolicy.dart';
import 'package:sporforya/createlisting/facilities/facilitynicejob.dart';
import 'package:sporforya/createlisting/facilities/facilityscheduleandprice.dart';
...
class FacilityCencellationPolicy extends StatefulWidget {
  @override
  _FacilityCencellationPolicyState createState() =>
      _FacilityCencellationPolicyState();
}

class _FacilityCencellationPolicyState
    extends State<FacilityCencellationPolicy> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Please choose your cancellation and refund policy that works best for your event",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 14,
