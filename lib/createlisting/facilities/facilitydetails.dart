          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Please tell us about your facility.  The more information you provide, the easier it will be for people to book",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 14,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Select the Sport or Activity that could take\nplace",
                        style:
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Select the Type of Facility",
                        style:
                            TextStyle(fontFamily: 'SF-Pro-Bold', fontSize: 14)),
                  ],
                ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Name or Title of the Facility",
                        style:
                            TextStyle(fontFamily: 'SF-Pro-Bold', fontSize: 14)),
                  ],
                ),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: new InputDecoration(
                            ...
                            hintText:
                                'Briefly describe what you are offering, Whats included, the key features, benefits or value that make your facility special or unique',
                            hintStyle:
                                TextStyle(fontFamily: 'SF-Pro', fontSize: 12),
                            hintMaxLines: 3),
                      ),
                      ...
                      child: TextFormField(
                        ...
                        decoration: new InputDecoration(
                            ...
                            contentPadding: EdgeInsets.only(
                                left: 15, bottom: 11, top: 11, right: 25),
                            hintText:
                                'Add any conditions, such as access, consumption, capacity,  inclement weather policy.  Or add a URL link to a web page or a document',
                            hintStyle:
                                TextStyle(fontFamily: 'SF-Pro', fontSize: 11),
                            hintMaxLines: 3),
                      ),
                    ),
                  ],
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Add Photos for Your Facility",
                        style:
                            TextStyle(fontFamily: 'SF-Pro-Bold', fontSize: 14)),
                    Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      "Photos help bring your facility to life and show people\nthe real experience.",
                      style: TextStyle(
                          fontFamily: 'SF-Pro',
                          fontSize: 10,
                          color: Color(0xff707070)),
