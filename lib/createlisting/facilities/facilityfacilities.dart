...
import 'package:sporforya/createlisting/facilities/facilitylocationinformation.dart';
...
class FacilityFacilities extends StatefulWidget {
  @override
  _FacilityFacilitiesState createState() => _FacilityFacilitiesState();
}
...
class _FacilityFacilitiesState extends State<FacilityFacilities> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Please tell us what Amenities and Equipment is available",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 14,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      "What Facilities are used for this facility?",
                      style: TextStyle(
                          fontFamily: 'SF-Pro-Bold',
                          fontSize: 14,
                          color: Colors.black),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      "What Equipment is available and included at\nthis facility?",
                      style: TextStyle(
                          fontFamily: 'SF-Pro-Bold',
                          fontSize: 14,
                          color: Colors.black),
              ...
              Padding(
                padding: EdgeInsets.only(
                    left: 20.0, right: 20.0, top: 50.0, bottom: 50),
                child: SizedBox(
                  height: 46,
