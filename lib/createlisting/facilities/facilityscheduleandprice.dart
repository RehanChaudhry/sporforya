...
class FacilityScheduleAndPrice extends StatefulWidget {
  @override
  _FacilityScheduleAndPriceState createState() =>
      _FacilityScheduleAndPriceState();
}
...
class _FacilityScheduleAndPriceState extends State<FacilityScheduleAndPrice> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Enter the dates, days, times,  and other particulars for your facility",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 14,
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30, top: 10, right: 40),
                child: Text(
                  "You have the option to add multiple schedules for your facility, using different dates, days, andtimes",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 13,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      "If your facility has multiple locations, then ",
                      style: TextStyle(
                          fontFamily: 'SF-Pro',
                          fontSize: 13,
                          color: Color(0xff3D3D3D)),
