...
class FacilityParticipantParticulars extends StatefulWidget {
  @override
  _FacilityParticipantParticularsState createState() =>
      _FacilityParticipantParticularsState();
}

class _FacilityParticipantParticularsState
    extends State<FacilityParticipantParticulars> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Add some particulars to describe who the facility is most suited to, and help Users choose what's best for them.",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 14,
