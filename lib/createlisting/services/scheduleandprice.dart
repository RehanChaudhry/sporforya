...
class ScheduleAndPrice extends StatefulWidget {
  @override
  _ScheduleAndPriceState createState() => _ScheduleAndPriceState();
}
...
class _ScheduleAndPriceState extends State<ScheduleAndPrice> {
  @override
          ...
          child: Column(
            children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                            builder: (BuildContext context) => Facilities()));
                      },
                    ),
                    Padding(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30, top: 10, right: 40),
                child: Text(
                  "You have the option to add multiple schedules for your service, using different dates, days, andtimes",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 13,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      "If your service has multiple locations, then ",
                      style: TextStyle(
                          fontFamily: 'SF-Pro',
                          fontSize: 13,
                          color: Color(0xff3D3D3D)),
