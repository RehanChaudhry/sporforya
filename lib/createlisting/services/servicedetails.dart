          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Name or Title of the Service",
                        style:
                            TextStyle(fontFamily: 'SF-Pro-Bold', fontSize: 14)),
                  ],
                ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Give your service a short distinct name or title",
                        style: TextStyle(
                            fontFamily: 'SF-Pro',
                            fontSize: 12,
                            color: Color(0xff707070))),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: new InputDecoration(
                            ...
                            hintText:
                                'Briefly describe what you are offering, Whats included, the key features, benefits or value that make your service special or unique',
                            hintStyle:
                                TextStyle(fontFamily: 'SF-Pro', fontSize: 12),
                            hintMaxLines: 3),
                      ),
                      ...
                      child: TextFormField(
                        ...
                        decoration: new InputDecoration(
                            ...
                            contentPadding: EdgeInsets.only(
                                left: 15, bottom: 11, top: 11, right: 25),
                            hintText:
                                'Introduce yourself or your staff, add some info about any experience, skills and qualifications',
                            hintStyle:
                                TextStyle(fontFamily: 'SF-Pro', fontSize: 12),
                            hintMaxLines: 3),
                      ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Add Photos for Your Service",
                        style:
                            TextStyle(fontFamily: 'SF-Pro-Bold', fontSize: 14)),
                    Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      "Photos help bring your service to life and show people\nthe real experience.",
                      style: TextStyle(
                          fontFamily: 'SF-Pro',
                          fontSize: 10,
                          color: Color(0xff707070)),
