...
class EventParticipantParticulars extends StatefulWidget {
  @override
  _EventParticipantParticularsState createState() =>
      _EventParticipantParticularsState();
}

class _EventParticipantParticularsState
    extends State<EventParticipantParticulars> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Add some particulars to describe who the event is most suited to, and help Users choose what's best for them.",
                  style: TextStyle(
                      fontFamily: 'SF-Pro',
                      fontSize: 14,
