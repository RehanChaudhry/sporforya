...
class EventCencellationPolicy extends StatefulWidget {
  @override
  _EventCencellationPolicyState createState() =>
      _EventCencellationPolicyState();
}

class _EventCencellationPolicyState extends State<EventCencellationPolicy> {
  @override
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (BuildContext context) => EventNiceJob()));
                    },
                    child: Text(
                      "Continue",
                      style: TextStyle(
