...
class EventNiceJob extends StatefulWidget {
  @override
  _EventNiceJobState createState() => _EventNiceJobState();
}

class _EventNiceJobState extends State<EventNiceJob> {
  @override
